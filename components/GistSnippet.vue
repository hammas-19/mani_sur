<template>
    <div class="gist mb-5">
        ...
        <div class="flex justify-between my-2">
            ...
            <div class="flex">
                ...
                <div class="flex flex-col">
                    <a id="username" href="https://github.com/hammas-19" target="_blank"
                        class="font-fira_bold text-[#92dfb9] text-xs pb-1 hover:cursor-pointer">
                        @hammas-19
                    </a>
                    <p class="font-fira_retina text-xs text-menu-text">Copied & pasted successfully!</p>
                </div>
            </div>

            <!-- details and stars -->
            <div class="flex text-menu-text font-fira_retina text-xs justify-self-end lg:mx-2">
                <div class="flex lg:mx-2 hover:cursor-not-allowed hover:text-white">
                    <img src="/icons/gist/comments.svg" alt="" class="w-4 h-4 mr-2">
                    <span @click="showComment(gist.id)">details</span>
                </div>
                <div class="hidden lg:flex hover:cursor-not-allowed hover:text-white">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="snippet-container border-[0.5px] rounded-md p-4 border-[#b1b6be] bg-[#172327]">
                <p class="text-[#b1b6be]">
                    <span class="text-blue-500">while</span> ( <span class="text-green-300">true</span> ) { <br>
                    // Browser freezer <br>
                    }
            ...
            <div class="snippet-container border-[0.5px] rounded-md p-4 border-[#b1b6be] bg-[#172327]">
                <p class="text-[#b1b6be]">
                    <span class="text-red-300">function</span> generateRandomEmoji() { <br>
                    <span class="text-teal-300">const</span> emojis = ["😂", "🎉", "😜", "🦄", "🍕", "🚀"]; <br>
                    <span class="text-red-300"> return </span> emojis[Math.floor(Math.random() * emojis.length)];<br>
                    }

                     <span class="text-red-300"> console</span>.<span class="text-blue-500">log</span> (generateRandomEmoji());

                </p>
            </div>
        </div>

        <div class="lg:flex hidden justify-between text-menu-text font-fira_retina mt-4 pt-4 border-top">
            <p id="comment" v-if="comment" class="w-5/6"> comment </p>
            <p v-else class="w-5/6">No comments.</p>
            <img src="/icons/close.svg" alt="" class="hover:cursor-not-allowed" @click="showComment(gist.id)">
        </div>
    </div>
</template>
