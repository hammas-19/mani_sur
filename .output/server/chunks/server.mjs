...
const _routes = [
  {
    ...
    component: () => import('./about-me.57566e73.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./contact-me.d952a50d.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index.a10e0987.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./projects.41822d7b.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.2b905f2a.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, _imports_0$1 as a, __nuxt_component_0$1 as b, useNuxtApp as c, entry$1 as default, useRuntimeConfig as u };
